...
export default function Footer() {
  return (
    <footer className="bg-ilwu-navy-dark border-t border-white/10 pt-12 pb-6 pattern-dots">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <div className="font-display text-white text-xl tracking-widest leading-tight">ILWU LOCAL 23</div>
                <div className="text-white/40 text-xs font-body mt-0.5">Port of Tacoma, Washington</div>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l.to}>
                  <Link to={l.to} className="text-white/55 hover:text-ilwu-gold text-sm font-body transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <address className="not-italic text-white/55 text-sm font-body space-y-1 leading-relaxed mb-5">
              ...
              {[
                ...
                <li key={l.href}>
                  <a href={l.href} target="_blank" rel="noopener noreferrer"
                    className="text-white/55 hover:text-ilwu-gold text-sm font-body transition-colors flex items-center gap-1">
                    {l.label}
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-white/20 text-xs font-body">International Longshore and Warehouse Union</p>
        </div>
      </div>
    </footer>
  )
