const officers = [
  ...
  },
  {
    ...
    bio:   'Manages Local 23 finances, meeting minutes, membership records, and official correspondence with the International.',
  },
  {
    name:  'Wyatt Ellis',
    ...
    bio:   'Maintains order at union meetings, oversees hall access, and assists in member safety and security matters.',
  },
]
  ...
  return (
    <div className="font-body min-h-screen bg-ilwu-bg">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(27,58,107,0.80) 0%, rgba(27,58,107,0.98) 100%), url('https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1400&q=80&auto=format&fit=crop')`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {officers.map(o => (
              <div
                key={o.name}
                className="bg-ilwu-navy border-t-4 border-ilwu-gold flex flex-col p-6 gap-4 shadow-sm hover:shadow-md transition-shadow"
              >
                {/* Photo placeholder */}
                <div className="w-16 h-16 rounded-full bg-ilwu-gold/15 border-2 border-ilwu-gold/30 flex items-center justify-center">
                  <svg className="w-8 h-8 text-ilwu-gold/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-white/55 text-sm font-body leading-relaxed flex-1">{o.bio}</p>

                <div className="space-y-2 border-t border-white/10 pt-4">
                  <a href={`tel:${o.phone.replace(/[^0-9]/g,'')}`}
                    className="flex items-center gap-2 text-white/55 hover:text-ilwu-gold text-sm font-mono transition-colors">
                    <svg className="w-3.5 h-3.5 text-ilwu-gold/50 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    {o.phone}
                  </a>
                  <a href={`mailto:${o.email}`}
                    className="flex items-center gap-2 text-white/55 hover:text-ilwu-gold text-xs font-mono transition-colors break-all">
                    <svg className="w-3.5 h-3.5 text-ilwu-gold/50 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-ilwu-dark/60 font-body text-sm leading-relaxed mb-6">
                The Joint Labor Relations Committee resolves dispatch disputes, work assignment issues, and day-to-day contract administration between Local 23 and PMA. LRC reps are your first line on the waterfront.
              </p>
              <div className="space-y-2">
                {lrc.map((m, i) => (
                  <div key={i} className="border border-ilwu-border bg-white px-5 py-3.5 flex items-center justify-between">
            ...
            <div>
              ...
              <p className="text-ilwu-dark/60 font-body text-sm leading-relaxed mb-6">
                The Safety Committee investigates accidents, conducts inspections, and advocates for hazard elimination on the docks. If you see an unsafe condition, report it immediately.
              </p>
              ...
              <div className="border border-ilwu-navy/20 bg-ilwu-navy/5 p-4">
                ...
                <p className="text-ilwu-dark/60 text-sm font-body">
                  Contact any officer at <a href="tel:+12535720220" className="font-mono text-ilwu-navy font-semibold hover:text-ilwu-gold transition-colors">(253) 572-0220</a>. Do not work unsafe conditions.
                </p>
              </div>
            </div>
          </div>
