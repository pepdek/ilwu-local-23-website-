        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-8">
              <div>
                ...
                <div className="bg-white border border-ilwu-border p-6 space-y-5 shadow-sm">
                  ...
                  <div>
                    ...
                    <a href="tel:+12535720220" className="font-mono text-ilwu-navy text-2xl font-medium tracking-wide hover:text-ilwu-blue transition-colors">
                      (253) 572-0220
                    </a>
                  </div>
                  <div>
              ...
              {/* Map placeholder - no photo, styled div */}
              <div>
                <div className="w-full h-48 bg-ilwu-navy pattern-dots border border-ilwu-border flex flex-col items-center justify-center gap-3">
                  ...
                  <p className="text-white/65 font-body text-xs text-center px-4">
                    3600 Port of Tacoma Rd<br />Tacoma, WA 98424
                  </p>
                  <a
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                {officers.map(o => (
                  <div key={o.name} className="bg-white border border-ilwu-border hover:border-ilwu-blue/40 p-5 shadow-sm transition-colors">
                    <h3 className="font-body font-bold text-ilwu-navy text-base">{o.name}</h3>
                    <p className="font-display text-ilwu-blue text-xs uppercase tracking-widest mt-0.5 mb-4">{o.title}</p>
                    <div className="space-y-2">
                      <a href={`tel:${o.phone.replace(/[^0-9]/g,'')}`}
                        ...
                        <svg className="w-3.5 h-3.5 text-ilwu-blue/60 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="border border-ilwu-navy/20 bg-ilwu-navy/5 p-6">
                ...
                <p className="text-ilwu-dark/45 font-body text-xs mb-5 italic">
