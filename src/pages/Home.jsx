  ...
  return (
    <div className="font-body">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(27,58,107,0.55) 0%, rgba(27,58,107,0.80) 55%, rgba(15,15,15,0.97) 100%), url('https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=1600&q=80&auto=format&fit=crop')`,
      ...
      {/* ── BLOODY THURSDAY COUNTDOWN (60% black - hard break from hero) ── */}
      <section className="bg-ilwu-dark border-t-2 border-ilwu-gold">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-16">
            ...
            <div className="flex-shrink-0">
              ...
              <p className="text-white/50 text-sm font-body mt-2">Spanaway Lake Park, Tacoma</p>
            </div>
            {/* Countdown */}
            <Countdown />
            {/* Context */}
            <div className="lg:border-l lg:border-white/10 lg:pl-16 max-w-sm">
      ...
      {/* ── PETITION (60% black) ── */}
      <section id="petition" className="bg-ilwu-dark border-t border-white/8 py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={s.n} className="border border-white/10 hover:border-ilwu-gold/30 p-5 bg-white/4 transition-colors">
      ...
      {/* ── UPCOMING DATES (10% light - breathing room) ── */}
      <section className="bg-ilwu-bg py-20 border-t border-ilwu-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {dates.map((d, i) => (
              <div key={i} className="bg-ilwu-navy p-6 flex flex-col gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-sm font-body">{d.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={m.name} className="bg-ilwu-dark/60 border border-white/10 p-8">
      ...
      {/* ── MEMBER QUICK LINKS (60% black) ── */}
      <section className="py-20 bg-ilwu-dark border-t border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
